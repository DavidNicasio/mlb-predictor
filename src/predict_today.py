...
if __name__ == "__main__":
    ...
    parser.add_argument("--win-model", default=None)
    parser.add_argument("--runs-model", default=None)
    parser.add_argument("--pdf", default=None, help="Ruta del PDF de predicciones de salida")
    parser.add_argument("--league", default=None, help="MLB o LMB")
    args = parser.parse_args()
    run(args.date, args.db_path, args.win_model, args.runs_model, args.pdf, league=args.league)
